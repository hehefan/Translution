...
def gpt_mini(seq_len, vocab_size):
...
def gpt_tiny(seq_len, vocab_size):
    return GPT(seq_len = seq_len,
               vocab_size = vocab_size,
               dim = 192,
               depth = 12,
...
def gpt_small(seq_len, vocab_size):
    return GPT(seq_len = seq_len,
               vocab_size = vocab_size,
               dim = 384,
               depth = 12,
...
def gpt_base(seq_len, vocab_size):
    return GPT(seq_len = seq_len,
               vocab_size = vocab_size,
               dim = 768,
               depth = 12,
...
def gpt_large(seq_len, vocab_size):
    return GPT(seq_len = seq_len,
               vocab_size = vocab_size,
               dim = 1024,
               depth = 24,
