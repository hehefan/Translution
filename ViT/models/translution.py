...
class TNN(nn.Module):
    def __init__(self, tnn_type,  hw_size, dim, depth, heads, dim_head, mlp_dim, pool = 'cls', dropout = 0., tln_num = None):
        super().__init__()
...
class ViT(nn.Module):
    def __init__(self, *, tnn_type, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0., tln_num = None, pos_embedding = False):
        ...
        self.translution = TNN(tnn_type, (image_height // patch_height, image_width // patch_width), dim, depth, heads, dim_head, mlp_dim, pool, dropout, tln_num)
